...
namespace WindowsFormsnew
{
    class Assembly2B
    {
        public Assembly2B(Inventor.Application InventorApplication, double[] arr, double[] textboxes, string CB)
        {
            ...
            if (CB == "YES")
            {
                sfilename = "C:\\Rahul\\Nozzle\\C2.ipt";
                oTrans = InventorApplication.TransientGeometry.CreateVector(0, 1, 0);
                // oTrans=InventorApplication.TransientGeometry.CreateVector()
            ...
            sfilename = "C:\\Rahul\\Nozzle\\C3.ipt";
            ...
            functions A_C = new functions();
            //A_C.FaceContraints(oAssyDoc, oC1, oC2A, 3, 1);
            //A_C.AxisContraints(oAssyDoc, oC1, oC2A, 1, 1);
            A_C.AxisContraints(oAssyDoc, oC1, oC2A, 1, 1);
            A_C.AxisContraints(oAssyDoc, oC1, oC2A, 1, 2);
            A_C.AxisContraints(oAssyDoc, oC1, oC2A, 1, 3);

            if (CB == "YES")
            {
                //A_C.FaceContraints(oAssyDoc, oC1, oC2B, 2, 3);
                A_C.AxisContraints(oAssyDoc, oC1, oC2B, 1, 1);
                A_C.AxisContraints(oAssyDoc, oC1, oC2B, 1, 2);
                A_C.AxisContraints(oAssyDoc, oC1, oC2B, 1, 3);
            }
            ...
            oAssyDoc.SaveAs("C:\\Rahul\\Nozzle\\NozzleAssembly.iam", false);
        }
    }
}

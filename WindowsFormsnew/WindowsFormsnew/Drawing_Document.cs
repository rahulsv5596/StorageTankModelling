...
{
    class Drawing_Document
    {
 


        public Drawing_Document(Inventor.Application InventorApplication,double length,double height,string[] Ship_Discription,string[] Discription, string[] MATL,double[] LGTH,double[] weight,double[] qty,double RollRadius,String[] MK)
        {
            ...
            OAssmDoc = (AssemblyDocument) InventorApplication.Documents.Open("C:\\Rahul\\Nozzle\\NozzleAssemblyflat.iam", false);
           ...
           // Matrix oPositionMatrix, oPositionMatrix2;
            ...
            NameValueMap oBaseViewOptions = InventorApplication.TransientObjects.CreateNameValueMap();

...
{
    class Component_3B2_C
    {
        public Component_3B2_C(Inventor.Application InventorApplication, double[] Narr, double[] Farr, double[] textboxes)
        {
            ...
            //oSketch2 = (PlanarSketch)oPar tCompDef.Sketches.Add(oPartCompDef.WorkPlanes[1]);
